...
interface AuthApiClient {
    ...
    /**
     * Ensure user data exists (create if not exists)
     * Optional - if provided, will be called when user is authenticated
     */
    ensureUser?: (userToken: string, defaultUserName?: string) => Promise<UserData>;
}
/**
