...
import { CharahomeEnvironment } from '@kurasuai-inc/charahome-api/client';
...
interface DerivedAppAuthConfigInput {
    derivedAppConfig: FirebaseOptions;
    derivedAppName: string;
    appId: string;
...
export { type AuthApiClient as A, type CreateAuthApiClientOptions as C, type DerivedAppAuthConfigInput as D, type LinkResult as L, type MergeAccountsRequest as M, type RegisterLinkRequest as R, type TokenClaims as T, type UseAuthReturn as U, type CHARAHOMEAuthConfig as a, type CheckLinkResult as b, type DualAuthState as c, type AccountLink as d, type CHARAHOMEApiSuccessResponse as e, type CHARAHOMEApiErrorResponse as f, type CHARAHOMEAuthProviderProps$1 as g, CHARAHOMEAuthProvider as h, type CHARAHOMEAuthProviderProps as i, useCharahomeToken as j, useIsAuthenticated as k, useIsAdmin as l, useAuth as u };
