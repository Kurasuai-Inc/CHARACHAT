...
__export(index_exports, {
  MinimalOnboardingFlow: () => MinimalOnboardingFlow,
  createMinimalOnboardingFetchAdapter: () => createMinimalOnboardingFetchAdapter
});
module.exports = __toCommonJS(index_exports);

// src/MinimalOnboardingFlow.tsx
var import_react = require("react");
var import_react2 = require("@kurasuai-inc/charahome-auth/react");
...
function MinimalOnboardingFlow({
  ...
  const [acceptTos, setAcceptTos] = (0, import_react.useState)(false);
  const [acceptPrivacy, setAcceptPrivacy] = (0, import_react.useState)(false);
  const [error, setError] = (0, import_react.useState)(null);
  const [busy, setBusy] = (0, import_react.useState)(false);
  const [profile, setProfile] = (0, import_react.useState)(null);
  const [lastResolvedUid, setLastResolvedUid] = (0, import_react.useState)(null);
  const [accountWasCreated, setAccountWasCreated] = (0, import_react.useState)(false);
  const resetAuthError = () => setError(null);
  const finish = (0, import_react.useCallback)(async (user, isNewAccount) => {
  ...
  const resolveProfileStep = (0, import_react.useCallback)(async (isNewAccount) => {
    const charahomeToken = await forceGetCharahomeToken();
    if (!charahomeToken) {
  ...
  const submitAuth = (0, import_react.useCallback)(async () => {
    setBusy(true);
    setError(null);
    try {
  ...
  const submitConsent = (0, import_react.useCallback)(async () => {
    setBusy(true);
    setError(null);
    try {
  ...
  const submitAge = (0, import_react.useCallback)(async () => {
    setBusy(true);
    setError(null);
    try {
  ...
  const currentTitle = (0, import_react.useMemo)(() => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", { style: {
    minHeight: "100vh",
    display: "flex",
    ...
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("header", { style: { ...panelStyle(true), marginBottom: "1.1rem" }, children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", { style: { margin: 0, fontSize: "1.55rem" }, children: currentTitle }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", { style: { margin: 0, color: "#475569", lineHeight: 1.6 }, children: [
        step === "auth" ? subtitle : "",
    ...
    step === "auth" ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: panelStyle(), children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { display: "flex", gap: "0.6rem", flexWrap: "wrap" }, children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { type: "button", style: secondaryButtonStyle(authMode === "login"), onClick: () => {
          setAuthMode("login");
          resetAuthError();
        }, children: "\u30ED\u30B0\u30A4\u30F3" }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { type: "button", style: secondaryButtonStyle(authMode === "register"), onClick: () => {
          setAuthMode("register");
          resetAuthError();
        }, children: "\u65B0\u898F\u767B\u9332" }),
        allowAnonymous ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { type: "button", style: secondaryButtonStyle(authMode === "anonymous"), onClick: () => {
          setAuthMode("anonymous");
          resetAuthError();
        }, children: "\u533F\u540D\u3067\u306F\u3058\u3081\u308B" }) : null
      ] }),
      authMode === "anonymous" ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { borderRadius: "1rem", background: "rgba(15, 23, 42, 0.04)", padding: "1rem", lineHeight: 1.6, color: "#475569" }, children: "\u533F\u540D\u3067\u958B\u59CB\u3059\u308B\u3068\u3001\u3042\u3068\u304B\u3089 CHARAHOME \u30A2\u30AB\u30A6\u30F3\u30C8\u3078\u5F15\u304D\u7D99\u3052\u307E\u3059\u3002" }) : /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { type: "button", style: primaryButtonStyle(busy || loading), disabled: busy || loading, onClick: () => {
        void submitAuth();
      }, children: busy || loading ? "\u51E6\u7406\u4E2D..." : submitLabel })
    ] }) : null,
    step === "consent" ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: panelStyle(), children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", { style: { display: "flex", gap: "0.75rem", alignItems: "flex-start", lineHeight: 1.6 }, children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", { type: "checkbox", checked: acceptTos, onChange: (event) => setAcceptTos(event.target.checked) }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("a", { href: tosUrl, target: "_blank", rel: "noreferrer", children: "\u5229\u7528\u898F\u7D04" }),
          " \u306B\u540C\u610F\u3057\u307E\u3059\u3002"
        ] })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", { style: { display: "flex", gap: "0.75rem", alignItems: "flex-start", lineHeight: 1.6 }, children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", { type: "checkbox", checked: acceptPrivacy, onChange: (event) => setAcceptPrivacy(event.target.checked) }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("a", { href: privacyPolicyUrl, target: "_blank", rel: "noreferrer", children: "\u30D7\u30E9\u30A4\u30D0\u30B7\u30FC\u30DD\u30EA\u30B7\u30FC" }),
          " \u306B\u540C\u610F\u3057\u307E\u3059\u3002"
        ] })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { type: "button", style: primaryButtonStyle(busy), disabled: busy, onClick: () => {
        void submitConsent();
      }, children: busy ? "\u4FDD\u5B58\u4E2D..." : "\u540C\u610F\u3057\u3066\u7D9A\u3051\u308B" })
    ] }) : null,
    step === "age" ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: panelStyle(), children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
        "input",
        {
          style: fieldStyle(),
    ...
    step === "blocked" ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: panelStyle(), children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { borderRadius: "1rem", background: "rgba(15, 23, 42, 0.04)", padding: "1rem", lineHeight: 1.7, color: "#475569" }, children: "\u5E74\u9F62\u6761\u4EF6\u3092\u6E80\u305F\u3057\u3066\u3044\u306A\u3044\u305F\u3081\u3001\u3053\u306E\u30B5\u30FC\u30D3\u30B9\u306F\u5229\u7528\u3067\u304D\u307E\u305B\u3093\u3002" }) }) : null,
    step === "complete" ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: panelStyle(), children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { borderRadius: "1rem", background: "rgba(15, 118, 110, 0.1)", padding: "1rem", lineHeight: 1.7, color: "#115e59" }, children: [
      "\u30A2\u30AB\u30A6\u30F3\u30C8\u6E96\u5099\u304C\u5B8C\u4E86\u3057\u307E\u3057\u305F\u3002",
